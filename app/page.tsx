      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-[#09090B]/80 border-b border-[#27272A]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 group cursor-pointer" onClick={() => router.push('/')}>
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-indigo-500/20 via-[#18181B] to-[#18181B] border border-indigo-500/30 flex items-center justify-center shadow-lg shadow-indigo-500/5 group-hover:border-indigo-500/50 transition-all">
              <Sparkles className="w-4 h-4 text-indigo-400" />
            </div>
            <div className="flex flex-col">
              <span className="font-bold tracking-tight text-lg text-[#FAFAFA] flex items-center gap-1.5">
                WorldKnows
                <span className="inline-block w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse"></span>
              </span>
              <span className="text-[10px] uppercase tracking-widest text-[#71717A] -mt-1 font-medium">Knowledge Platform</span>
            </div>
          </div>

          {/* Center Navigation */}
          <nav className="hidden md:flex items-center gap-1 bg-[#111113] border border-[#27272A] rounded-full px-4 py-1.5 shadow-sm">
            <Link href="/search" className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-medium text-[#A1A1AA] hover:text-[#FAFAFA] hover:bg-[#18181B] transition-all">
              <Compass className="w-3.5 h-3.5 text-indigo-400" />
              Explore
            </Link>
            <Link href="/topics" className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-medium text-[#A1A1AA] hover:text-[#FAFAFA] hover:bg-[#18181B] transition-all">
              <Layers className="w-3.5 h-3.5 text-indigo-400" />
              Topics
            </Link>
            <Link href="/research" className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-medium text-[#A1A1AA] hover:text-[#FAFAFA] hover:bg-[#18181B] transition-all">
